  ...
  for(int L=0; L<n_pyr_levels_; ++L)
  {
    ...
    vector<fast::fast_xy> fast_corners;
      ...
      fast::fast_corner_detect_10_sse2(
          ...
          img_pyr[L].rows, img_pyr[L].cols, 3, fast_corners);   // 20
#elif HAVE_FAST_NEON
      fast::fast_corner_detect_9_neon(
          (fast::fast_byte*) img_pyr[L].data, img_pyr[L].cols,
          img_pyr[L].rows, img_pyr[L].cols, 3, fast_corners);
#else
    ...
    fast::fast_corner_score_10((fast::fast_byte*) img_pyr[L].data, img_pyr[L].cols, fast_corners,3, scores);// 20
